...
$$ {#eq-race-likelihood}
which, as a function of $t$, is the "defective distribution" for $i$, meaning that it integrates to the probability of response $i$.
...
```{r LBA missing tail illustration}
#| label: fig-LBAtrunc
#| fig-cap: Illustration of Missing Upper Response Times in the Linear Ballistic Accumulator
#| apa-note: "This figure illustrates how upper censoring and truncation relate to the LBA and the defective density. Dashed lines represent the missing RT trials."
#| fig-asp: 0.618
...
#| fig-cap: "Root Mean Squared Errors and Quadratic Wasserstein Distances for Upper Censoring"
...
#| fig-alt: ""
#| apa-note: "Model root mean squared errors (RMSE) and quadratic Wasserstein distances ($W_2$) for the linear ballistic accumulator model (LBA). Lower RMSE and $W_2$ indicate better parameter recovery."
#| fig-asp: 0.7
...
#| apa-note: "Quadratic Wasserstein distances ($W_2$) between the true LBA parameters and the LBA parameter posteriors. Each row denotes the LBA parameter shown in the boxes on the right, and each column denotes the tail that was missing and whether responses are known or unknown."
#| fig-asp: 0.9
...
#| apa-note: "Model root mean squared errors (RMSE) and quadratic Wasserstein distances ($W_2$) for the log-normal race model (LNR). Lower RMSE and $W_2$ indicate better parameter recovery."
#| fig-asp: 0.7
...
#| apa-note: "Quadratic Wasserstein distances ($W_2$) between the true Log-Normal Race (LNR) parameters and the LNR parameter posteriors. Each row denotes the LNR parameter shown in the boxes on the right, and each column denotes the tail that was missing and whether responses are known or unknown."
#| fig-asp: 0.9
...
#| apa-note: "Quadratic Wasserstein distances ($W_2$) between the true racing diffusion model (RDM) parameters and the RDM parameter posteriors. Each row denotes the RDM parameter shown in the boxes on the right, and each column denotes the tail that was missing and whether responses are known or unknown."
#| fig-asp: 0.9
...
# Supplementary Materials Study 1 {#apx-study1}



# Supplementary Materials Study 2 {#apx-study2}
## Linear Ballistic Accumulator Model
### Model Distances
```{r}
#| include: true
#| label: fig-MAE-both-LBA
#| fig-cap: "Mean Absolute Errors for the Linear Ballistic Accumulator (LBA)"
#| fig-alt: ""
#| apa-note: ""
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Known"
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Unknown"
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Known"
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Unknown"
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Known"
...
#| fig-cap: "Linear Ballistic Accumulator Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Unknown"
...
#| fig-cap: "MAE for the Log-Normal Race (LNR)"
#| fig-alt: ""
#| apa-note: "Something something"
...
#| fig-cap: "R for the Log-Normal Race Model (LNR)"
#| fig-alt: ""
#| apa-note: "Something something"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Known"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Unknown"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Known"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Unknown"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Known"
...
#| fig-cap: "Log-Normal Race Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Unknown"
...
#| fig-cap: "MAE for the Racing Diffusion Model (RDM)"
#| fig-alt: ""
#| apa-note: "Something something"
...
#| fig-cap: "R for the Racing Diffusion Model Model (RDM)"
#| fig-alt: ""
#| apa-note: "Something something"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Known"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Upper Tail and Responses Unknown"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Known"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Lower Tail and Responses Unknown"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Known"
...
#| fig-cap: "Racing Diffusion Model Posterior Medians and 95% Credible Intervals with Missing Upper and Lower Tail and Responses Unknown"
