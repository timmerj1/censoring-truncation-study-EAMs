...
parsbad <- c(log(.05),1,1.2,log(.05),log(1.2),log(.6))
names(parsbad)<- names(parsLBA)

badstuff <- EMC2:::calc_ll(t(as.matrix(parsbad)), dadm, constants = constants, designs = designs, type = c_name, p_types = p_types, min_ll = log(1e-10), group_idx = parameter_indices)
